...
Imports data that is non-linear model and shows increasing variance as the predictor increases
```{r}
...
Putting smooth lines through data clouds, and we can control how smooth we want the fit to be.
```{r}
train_df |> 
...
Adding redictions for several models to a data frame and then “pivoting” so the result is a tidy, “long” dataset 
```{r}
train_df |> 
